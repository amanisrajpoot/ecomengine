...
Revision ID: 45f916891622
Revises: e30125ec8d91
Create Date: 2026-08-09 05:23:04.806562
...
revision: str = '45f916891622'
down_revision: Union[str, None] = 'e30125ec8d91'
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('on_hand >= reserved', name='ck_inventory_available_nonneg'),
