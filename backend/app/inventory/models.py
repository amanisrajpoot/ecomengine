...
class InventoryItem(UUIDPrimaryKeyMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("on_hand >= reserved", name="ck_inventory_on_hand_gte_reserved"),
        Index("ix_inventory_business_location", "business_id", "location_id"),
    )
...
class StockMovement(UUIDPrimaryKeyMixin, Base):
    ...
    __table_args__ = (Index("ix_stock_movements_item_created", "inventory_item_id", "created_at"),)
