...
from sqlalchemy import Boolean, Double, ForeignKey, String, Text, UniqueConstraint
...
class DeliveryPartnerProfile(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", name="uq_delivery_partner_profiles_user_id"),)
