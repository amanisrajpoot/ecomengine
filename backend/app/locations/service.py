...
from app.locations.schemas import BusinessLocationCreate, BusinessLocationUpdate
...
async def get_location(
    ...
    *,
    ...
    if not location:
        raise AppError("LOCATION_NOT_FOUND", "Business location not found", status_code=404)
    return location
