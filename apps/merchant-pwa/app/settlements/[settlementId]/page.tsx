...
export default function MerchantSettlementDetailPage() {
  ...
  return (
    <main className="mx-auto max-w-xl px-5 py-10">
      <Link href="/settlements" className="text-sm text-amber-100/50 hover:text-amber-50">
        ← Settlements
      </Link>
      <p className="mt-4 font-display text-4xl text-amber-50">Settlement</p>
      ...
      {settlement ? (
        <div className="mt-8 space-y-6">
          ...
          />
          <section className="rounded-2xl border border-amber-200/10 px-4 py-4 text-sm text-amber-100/70">
            <p className="font-medium text-amber-50/90">Report summary</p>
            <pre className="mt-3 overflow-x-auto text-xs text-amber-100/55">
