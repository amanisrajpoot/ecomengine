...
export default function RegisterPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      if (!tenantId.trim()) {
        throw new Error("Tenant ID is required to register.");
      }
  ...
  return (
    <div className="mx-auto max-w-md space-y-4">
      <div>
        ...
        <p className="text-sm text-emerald-200/70">Register as a customer in your tenant.</p>
      </div>
      ...
      <p className="text-sm text-emerald-200/70">
        ...
        <Link href="/login" className="text-emerald-300 underline hover:text-emerald-100">
          Sign in
        </Link>
      </p>
